(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["aprender-jogar-aprender-jogar-module"], {
  ...
  function srcAppAprenderJogarAprenderJogarPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let AprenderJogarPage = class AprenderJogarPage {
      ...
      getTopicos() {
        return this.listTopicos = [{
          titulo: "Aprenda a jogar, ganhe dinheiro e boa sorte!",
          image: null,
          texto: ["No bicho existem alguns tipos de apostas que obedecem propor\xE7\xF5es fixas, de acordo com a\n                     probabilidade de acerto, e que podem variar de cidade em cidade. Por exemplo no Rio de Janeiro,\n                     apostando em um animal na cabe\xE7a (1\xBA. Pr\xEAmio) a propor\xE7\xE3o de ganho \xE9 de 1 para 18, ou seja, para\n                     cada Real apostado, voc\xEA ganharia R$18,00 se seu animal sa\xEDsse no sorteio.", "Abaixo temos alguns exemplos: <br>\n                     Grupo - R$18,00 <br>\n                     Milhar - R$4.000,00 <br>\n                     Centena - R$600,00 <br>\n                     Dezena - R$60,00 <br>\n                     Passe - R$ 75,00 ", "Os sorteios s\xE3o realizados 4 vezes ao dia, de segunda \xE0 s\xE1bado no jogo do bicho e um sorteio aos\n                     domingos. Em cada um deles se sorteia 5 n\xFAmeros de 4 algoritmos cada um."]
        }, {
          titulo: "Grupo",
          image: null,
          texto: [" Pagamento da aposta: 18:1 <br>", "Voc\xEA escolhe um grupo (bicho) e se um dos n\xFAmeros que fazem parte desse grupo sai na dezena do\n                     primeiro pr\xEAmio dos resultados (chamado \"cabe\xE7a\"), voc\xEA ganha 18 vezes o valor que voc\xEA apostou."]
        }, {
          titulo: "Duques de Dezena",
          image: null,
          texto: ["Pagamento da Aposta: 300:1. <br>", "Voc\xEA aposta em duas dezenas, e se as duas sa\xEDrem entre os cinco primeiros pr\xEAmios, voc\xEA ganha 300\n                     vezes o valor da aposta."]
        }, {
          titulo: "Ternos de Dezena",
          image: null,
          texto: ["Pagamento da Aposta: 3000:1. <br>", "Voc\xEA aposta em 3 dezenas, e se as tr\xEAs saem entre os cinco primeiros pr\xEAmios (ou seja, de 5\n                     dezenas, voc\xEA acerta 3), voc\xEA ganha 3000 vezes o valor apostado."]
        }, {
          titulo: "Milhar",
          image: null,
          texto: ["Pagamento da aposta: 4000:1. <br>", "Voc\xEA aposta em um n\xFAmero de 4 d\xEDgitos, um milhar, e se esse milhar cair no primeiro pr\xEAmio do\n                     sorteio em que voc\xEA apostou, voc\xEA ganha 4000 vezes o valor da sua aposta!"]
        }];
      }
